...
export const metadata: Metadata = {
  title: 'Zionix - Solana DEX',
  description: 'Experience lightning-fast token swaps on Solana with the best rates and lowest fees.',
}
...
export default function RootLayout({
  ...
  return (
    <html lang="en" className="dark">
      <body className={`${inter.className} bg-[#000510]`}>
